              ...
              >
                <div className="relative">
                  <motion.div
                    ...
                    className="absolute -inset-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full blur-2xl opacity-30"
                  />
                  <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl">
                    <div className="grid grid-cols-2 gap-6">
                      {[
                        { icon: Globe, label: "Web", color: "from-indigo-500 to-purple-500", count: "150+" },
                        { icon: Smartphone, label: "Apps", color: "from-emerald-500 to-teal-500", count: "80+" },
                        { icon: Cloud, label: "SaaS", color: "from-amber-500 to-orange-500", count: "45+" },
                        { icon: Cog, label: "Auto", color: "from-rose-500 to-pink-500", count: "200+" },
                      ].map((item, i) => (
                        <motion.div
                          key={item.label}
                          initial={{ scale: 0 }}
                          ...
                          className="flex flex-col items-center p-4 rounded-2xl bg-gradient-to-br from-gray-50 to-white"
                        >
                          ...
                          <span className="text-xs text-muted-foreground">{item.label} Projects</span>
                        </motion.div>
                      ))}
                    </div>
                    <motion.div
                      ...
                      className="mt-6 h-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full"
                    />
